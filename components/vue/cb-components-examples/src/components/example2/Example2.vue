<template>
  <div class="ex2 container">
    ...
    <div class="theme-palette" style="margin-top: 15px">
      <button id="theme-1" class="ex2-button" @click="e => setTheme(e, 0)">Theme1</button>
      <button id="theme-2" class="ex2-button" @click="e => setTheme(e, 1)">Theme2</button>
      <button id="theme-3" class="ex2-button" @click="e => setTheme(e, 2)">Theme3</button>
      <button id="theme-4" class="ex2-button" @click="e => setTheme(e, 3)">Theme4</button>
    </div>

    ...
    <div class="ex3-wrap">      
      <form id="payment">
            ...
            <div class="ex3-fieldset">
                ...
                >
                  ...
                  <div class="ex3-fields">
                    <div class="ex3-field">                    
                        <CardExpiry class="ex3-input" @focus="onFocus" @blur="onBlur"/>
                        <i class="ex3-bar"></i>                    
                    </div>
                    <div class="ex3-field">                    
          ...
          <div class="language-palette" style="margin-top: 15px;">
            ...
            <button id="es" class="ex3-button small" @click="setLocale">ES</button>
            <button id="pt" class="ex3-button small" @click="setLocale">PT</button>
            <button id="it" class="ex3-button small" @click="setLocale">IT</button>
            <button id="de" class="ex3-button small" @click="setLocale">DE</button>
          </div>
      </form>
  </div>
  </div>

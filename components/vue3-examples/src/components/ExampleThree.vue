      ...
      <form id="payment">
        <div class="ex3-contain">
          <div class="ex3-fieldset">
            ...
            >
              <div class="ex3-field">
                <CardNumber class="ex3-input" @focus="onFocus" @blur="onBlur" />
                <i class="ex3-bar"></i>
              </div>
              <div class="ex3-fields">
                ...
                <div class="ex3-field">
                  <CardCvv class="ex3-input" @focus="onFocus" @blur="onBlur" />
                  <i class="ex3-bar"></i>
                </div>
              </div>
            </CardComponent>
        ...
        <div id="error" class="error" role="alert" v-if="errorMessage">
          {{ errorMessage }}
        </div>
        ...
        <div class="language-palette" style="margin-top: 15px">
          <button id="en" class="ex3-button small" @click="setLocale">
            EN
          </button>
          <button id="fr" class="ex3-button small" @click="setLocale">
            FR
          </button>
          <button id="es" class="ex3-button small" @click="setLocale">
            ES
          </button>
          <button id="pt" class="ex3-button small" @click="setLocale">
            PT
          </button>
          <button id="it" class="ex3-button small" @click="setLocale">
            IT
          </button>
          <button id="de" class="ex3-button small" @click="setLocale">
            DE
          </button>
        </div>
      </form>
...
export default {
  ...
  methods: {
    ...
    // Called when card component is mounted in the DOM and ready
    onReady() {
  ...
  computed: {
    fonts() {
      return ["https://fonts.googleapis.com/css?family=Raleway:300,500,600"];
    },
    classes() {
      return {
        focus: "focus",
    ...
    styles() {
      return {
        base: {
          ...
          fontWeight: "500",
          fontFamily:
            "Raleway,-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica Neue, sans-serif",
          fontSize: "16px",
